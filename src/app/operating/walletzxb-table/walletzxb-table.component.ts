...
@Component({
  selector: 'walletzxbtable',
  templateUrl: './walletzxb-table.component.html',
  styleUrls: ['./walletzxb-table.component.scss'],
  animations: [
    flyIn
  ]
})
export class WalletzxbComponent implements OnInit {
    ...
    ngOnInit() {
       ...
       this.down = this.constant.root+'/workspace/operating/walletzxbtable';
    }
    public getByPage(page: number) {
     ...
     let opt = {
         ...
         url:_this.constant.root+"ydmgmt/api/statistics/queryActivityProjectData",
         type:"get"
       }
       this.down = this.constant.root+"ydmgmt/api/statistics/exportActivityProjectData?"+this.constant.getParams(opt.req);

...
@Component({
  selector: 'monthprovincetable',
  templateUrl: './monthprovince-table.component.html',
  styleUrls: ['./monthprovince-table.component.scss'],
  animations: [
    flyIn
  ]
})
export class MonthprovinceComponent implements OnInit {
   public constant: Constant = new Constant();
    ...
    public getByPage(page: number) {
     ...
     let opt = {
         ...
         url:_this.constant.root+"ydmgmt/api/statistics/queryYYMonthlyReportByProvince",
         type:"get"
       }
       this.down = this.constant.root+"ydmgmt/api/statistics/exportYYMonthlyReportByProvince?"+this.constant.getParams(opt.req);

...
@Component({
  selector: 'everychart-table',
  templateUrl: './everychart-table.component.html',
  styleUrls: ['./everychart-table.component.scss'],
  animations: [
    flyIn
  ]
})
export class EverychartTableComponent implements OnInit {
  ...
  public getByPage(): void {
     ...
     let opt = {
       ...
       url:_this.constant.root+"ydmgmt/api/statistics/queryDayStatis",
       type:"get"
     }

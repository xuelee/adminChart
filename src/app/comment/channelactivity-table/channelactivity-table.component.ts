...
@Component({
  selector: 'channelactivity-table',
  templateUrl: './channelactivity-table.component.html',
  styleUrls: ['./channelactivity-table.component.scss'],
  animations: [
    flyIn
  ]
})
export class ChannelactivityTableComponent implements OnInit {
  ...
  public getByPage(page: Number): void {
     ...
     let opt = {
       ...
       url:_this.constant.root+"ydmgmt/api/statistics/getCampaignStatisByChannel",
       type:"get"
     }
